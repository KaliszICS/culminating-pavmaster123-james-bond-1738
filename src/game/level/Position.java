...
public class Position{
    ...
    /**
     * Moves the x-coordinate of the Position by a given value.
     * @param x The value to move the x-coordinate by.
     */
    ...
    /**
     * Moves the y-coordinate of the Position by a given value.
     * @param y The value to move the y-coordinate by.
     */
