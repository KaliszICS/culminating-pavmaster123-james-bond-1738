...
import game.level.GameButton;
import game.level.Level;
import game.level.Position;
import game.level.Thing;
...
public class Save{
    ...
    /**
     * Saves the Player's current KeyBindings to a file.
     */
    ...
    /**
     * Loads the Player's KeyBindings from a file.
     */
    public static void loadKeybindings(){
        try{
            ...
            scanner.close();
        }catch(Exception e){ // likely that no keybindings were found, so make new ones.
            Save.save();
        }
    }
