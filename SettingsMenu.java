...
public class SettingsMenu implements Displayable{
    ...
    public void render(Graphics2D g, int width, int height) {
        ...
        volumeUpButton = new Button("Volume +", width/2 - buttonWidth/2, startY, buttonWidth, buttonHeight);
        volumeDownButton = new Button("Volume -", width/2 - buttonWidth/2, startY + buttonHeight + buttonSpacing, buttonWidth, buttonHeight);

        // Create difficulty button
        difficultyButton = new Button("Difficulty: " + difficulty, width/2 - buttonWidth/2, startY + (buttonHeight + buttonSpacing) * 2, buttonWidth, buttonHeight);

        // Create back button
        backButton = new Button("Back", width/2 - buttonWidth/2, startY + (buttonHeight + buttonSpacing) * 4, buttonWidth, buttonHeight);
        // Draw background
